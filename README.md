...
또한 2023 Best Of Best(BoB)11기 보안제품개발 트랙에 속해있었습니다.  
저는 다양한 보안분야 중 양자내성암호(Open Quantum Safe), 클라우드 보안(Cloud Security), 사용자 인증(User Authentication), 접근제한(Access Control),  블록체인(BlockChain) 분야등 다양한 보안분야에 관심이 있습니다.
